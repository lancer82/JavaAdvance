package com.hbliti.example4.generic.daoimpl;
...
import com.hbliti.example4.generic.dao.BaseDao;
import com.hbliti.example4.generic.helper.JdbcConn;;
...
public class BaseDaoImpl<T> implements BaseDao<T> {
    ...
    public void add(T t) {
        ...
        try {
            ...
            statement = JdbcConn.getPreparedStatement(sql);  //实例化PreparedStatement.
            //为sql语句赋值.
            statement = JdbcConn.setPreparedStatementParam(statement,
                    argType);
        	...
        	JdbcConn.release(statement, null);  //释放资源.
        }
    }
    ...
    public void delete(T t) {
        ...
        try {
        	...
        	JdbcConn.release(statement, null);
        }
    }
